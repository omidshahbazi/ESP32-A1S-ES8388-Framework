...
enum class GPIOPins
{
	Pin2 = (uint8)GPIO_NUM_2,	// Analog/Digital - Input/Output (Cannot be Bonnected in Root Mode)
	Pin4 = (uint8)GPIO_NUM_4,	// Analog/Digital - Input/Output (Cannot be Bonnected in Root Mode)
	Pin12 = (uint8)GPIO_NUM_12, // Analog/Digital - Input/Output (Cannot be Bonnected in Root Mode)
	...
	Pin22 = (uint8)GPIO_NUM_22, // Digital - Input/Output (Cannot be Bonnected in Root Mode)
